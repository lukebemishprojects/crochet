...
class MinecraftLibrariesMavenContent {
    static void applyContent(RepositoryContentDescriptor descriptor) {
        descriptor.includeModule("at.yawk.lz4", "lz4-java");
        descriptor.includeModule("ca.weblite", "java-objc-bridge");
        descriptor.includeModule("com.azure", "azure-json");
        ...
        descriptor.includeModule("io.netty", "netty-codec-base");
        descriptor.includeModule("io.netty", "netty-codec-compression");
        descriptor.includeModule("io.netty", "netty-codec-http");
        ...
        descriptor.includeModule("io.netty", "netty-transport-classes-kqueue");
        descriptor.includeModule("io.netty", "netty-transport-native-epoll");
        descriptor.includeModule("io.netty", "netty-transport-native-kqueue");
        ...
        descriptor.includeModule("org.jspecify", "jspecify");
        ...
        descriptor.includeModule("org.lwjgl", "lwjgl-shaderc");
        descriptor.includeModule("org.lwjgl", "lwjgl-spvc");
        descriptor.includeModule("org.lwjgl", "lwjgl-stb");
        descriptor.includeModule("org.lwjgl", "lwjgl-tinyfd");
        descriptor.includeModule("org.lwjgl", "lwjgl-vma");
        descriptor.includeModule("org.lwjgl", "lwjgl-vulkan");
        descriptor.includeModule("org.lwjgl", "lwjgl");
        descriptor.includeModule("org.slf4j", "slf4j-api");
        descriptor.includeModule("dev.onvoid.webrtc", "webrtc-java");
